...
function InternshipPage() {
  ...
  // FIX: Added linkedin and portfolio to the form state
  const [form, setForm] = useState({ 
    name: "", phone: "", altPhone: "", college: "", stream: "", 
    year: "1st Year", brand: "MyTripRaja", role: "", duration: "1 Month",
    linkedin: "", portfolio: "" 
  });
    ...
    try {
      ...
      try {
        await emailjs.send(
          ...
          { to_name: form.name, to_email: verifiedEmail, application_id: uniqueId, brand: form.brand, role: form.role || "General Application" },
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <div className="space-y-4 mb-10">
              <div className="p-5 bg-white/10 backdrop-blur-md border-l-4 border-corp-red shadow-sm">
              ...
              <div className="p-5 bg-white/10 backdrop-blur-md border-l-4 border-corp-gold shadow-sm">
            ...
            {sentAppId ? (
              ...
              <form onSubmit={handle} className="space-y-5">
                ...
                <div>
                  ...
                  <input type="text" disabled value={verifiedEmail} className="w-full px-3 py-2 border border-gray-200 bg-gray-50 text-gray-500 rounded-sm text-sm" />
                </div>

                <div>
                  <label className="block text-gray-900 text-[10px] font-bold tracking-widest uppercase mb-2">Full Name</label>
                  <input type="text" required value={form.name} onChange={e => setForm({ ...form, name: e.target.value })} className="w-full px-3 py-2 border border-gray-300 rounded-sm focus:border-corp-blue text-sm" />
                </div>

                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-gray-900 text-[10px] font-bold tracking-widest uppercase mb-2">Primary Phone *</label>
                    <input type="tel" required maxLength="10" value={form.phone} onChange={e => setForm({ ...form, phone: e.target.value.replace(/\D/g,'') })} className="w-full px-3 py-2 border border-gray-300 rounded-sm focus:border-corp-blue text-sm" />
                  </div>
                  <div>
                    <label className="block text-gray-900 text-[10px] font-bold tracking-widest uppercase mb-2">Alt Phone (Optional)</label>
                    <input type="tel" maxLength="10" value={form.altPhone} onChange={e => setForm({ ...form, altPhone: e.target.value.replace(/\D/g,'') })} className="w-full px-3 py-2 border border-gray-300 rounded-sm focus:border-corp-blue text-sm" />
                  </div>
                </div>

                <div>
                  <label className="block text-gray-900 text-[10px] font-bold tracking-widest uppercase mb-2">College Name & Location</label>
                  <input type="text" required value={form.college} onChange={e => setForm({ ...form, college: e.target.value })} className="w-full px-3 py-2 border border-gray-300 rounded-sm focus:border-corp-blue text-sm" />
                </div>

                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-gray-900 text-[10px] font-bold tracking-widest uppercase mb-2">Course / Stream</label>
                    <input type="text" required placeholder="e.g. M.Com, BBA" value={form.stream} onChange={e => setForm({ ...form, stream: e.target.value })} className="w-full px-3 py-2 border border-gray-300 rounded-sm focus:border-corp-blue text-sm" />
                  </div>
                  <div>
                    <label className="block text-gray-900 text-[10px] font-bold tracking-widest uppercase mb-2">Year of Study</label>
                    <select value={form.year} onChange={e => setForm({ ...form, year: e.target.value })} className="w-full px-3 py-2 border border-gray-300 rounded-sm focus:border-corp-blue text-sm bg-white">
                ...
                {/* FIX: New Optional LinkedIn and Portfolio Fields */}
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-gray-900 text-[10px] font-bold tracking-widest uppercase mb-2">LinkedIn Profile (Optional)</label>
                    <input type="url" placeholder="https://linkedin.com/in/..." value={form.linkedin} onChange={e => setForm({ ...form, linkedin: e.target.value })} className="w-full px-3 py-2 border border-gray-300 rounded-sm focus:border-corp-blue text-sm" />
                  </div>
                  <div>
                    ...
                    <input type="url" placeholder="https://..." value={form.portfolio} onChange={e => setForm({ ...form, portfolio: e.target.value })} className="w-full px-3 py-2 border border-gray-300 rounded-sm focus:border-corp-blue text-sm" />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 pt-2">
                  <div>
                    ...
                    <select value={form.brand} onChange={e => setForm({ ...form, brand: e.target.value })} className="w-full px-3 py-2 border border-gray-300 rounded-sm focus:border-corp-blue text-sm bg-white">
                  ...
                  <div>
                    ...
                    <select value={form.duration} onChange={e => setForm({ ...form, duration: e.target.value })} className="w-full px-3 py-2 border border-gray-300 rounded-sm focus:border-corp-blue text-sm bg-white">
