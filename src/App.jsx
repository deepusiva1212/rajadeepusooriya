  ...
  return (
    <header
      className={`fixed top-0 w-full z-50 transition-all duration-300 ${
        scrolled || view !== "home"
          ? "bg-corp-blue shadow-md shadow-gray-900/10"
          : "bg-transparent"
      }`}
    >
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 flex items-center justify-between h-16 lg:h-20 mt-1">
        <button onClick={() => navigateTo("home")} className="flex items-center gap-3 group text-left">
          ...
          <div className="hidden sm:block leading-tight">
            <span className="block text-white font-bold text-sm tracking-widest uppercase">
              Raja Deepu Sooriya
            </span>
            <span className="block text-corp-gold text-[10px] tracking-[0.2em] uppercase mt-0.5">
              Private Limited
            </span>
          </div>
        </button>
    ...
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-transparent text-center">
      <div className="relative max-w-4xl mx-auto px-6 pt-28 pb-20 flex flex-col items-center">
        ...
        <p className="text-gray-300 text-lg sm:text-xl leading-relaxed max-w-2xl mb-12 font-body font-light">
          Raja Deepu Sooriya Private Limited is a dynamic, innovation-driven enterprise committed to
          delivering exceptional value across diverse business sectors — founded on trust, integrity,
          and shared vision.
        </p>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <p className="text-gray-600 text-base leading-relaxed mb-5 font-body">
              Raja Deepu Sooriya Private Limited embodies the combined ambition and expertise of three
              co-founders whose complementary strengths form the backbone of the company.
            </p>
            <p className="text-gray-600 text-base leading-relaxed mb-8 font-body">
              Headquartered in Sankagiri, Tamil Nadu, the company operates with a commitment to
              transparency, corporate governance, and long-term value creation.
            </p>
            <button
              onClick={() => navigateTo("about-more")}
          ...
          <div className="space-y-4">
            ...
            {directors.map((d) => (
              <button
                key={d.name}
                onClick={() => navigateTo(`director-${d.id}`)}
      ...
      <div ref={ref} className={`relative max-w-7xl mx-auto px-6 lg:px-10 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
        ...
        <div className="mb-16">
          ...
          <p className="text-gray-400 text-base leading-relaxed mt-4 max-w-2xl font-body">
            Raja Deepu Sooriya Private Limited manages and scales specialized brands across multiple
            business sectors to deliver focused, high-quality services.
          </p>
        </div>
        <div className="grid lg:grid-cols-2 gap-8">
          <div className="group bg-corp-blue-mid/80 border border-white/10 p-10 rounded-sm hover:border-corp-red transition-all duration-500 backdrop-blur-md">
            ...
            <p className="text-gray-400 leading-relaxed mb-8">
              A comprehensive online travel and tourism platform. We provide seamless booking experiences,
              curated tour packages, destination research, and end-to-end travel management.
            </p>
          ...
          <div className="group bg-corp-blue-mid/80 border border-white/10 p-10 rounded-sm hover:border-corp-red transition-all duration-500 backdrop-blur-md">
            ...
            <p className="text-gray-400 leading-relaxed mb-8">
              A full-service digital marketing agency dedicated to brand growth. We specialize in search
              engine optimization, targeted ad campaigns, and strategic brand positioning.
            </p>
...
function Contact() {
  ...
  const handle = async (e) => {
    ...
    try {
      await addDoc(collection(db, "enquiries"), { ...form, submittedAt: serverTimestamp() });
      setSent(true);
      ...
      <div ref={ref} className={`max-w-7xl mx-auto px-6 lg:px-10 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <h2 className="font-display text-3xl sm:text-4xl xl:text-5xl font-black text-gray-900 leading-tight mb-6">
              Let's Start a<br /><span className="text-corp-red">Conversation</span>
            </h2>
            <div className="grid sm:grid-cols-2 gap-8 mt-12 border-l-2 border-corp-red/20 pl-6">
              <div>
                ...
                <a href="mailto:contact@rajadeepusooriya.com" className="text-corp-blue hover:text-corp-red text-sm font-mono leading-relaxed transition-colors">
                  contact@rajadeepusooriya.com
                </a>
              </div>
              <div>
                <div className="text-gray-900 font-bold text-xs tracking-widest uppercase mb-1.5">Contact Number</div>
                <a href="tel:+918098889088" className="text-corp-blue hover:text-corp-red text-sm font-mono leading-relaxed transition-colors">
                  +91 8098889088
                </a>
              </div>
              <div className="sm:col-span-2">
                ...
                <div className="text-gray-600 text-sm font-mono leading-relaxed">
                  17/1 DS Apartment, Tiruchengode Road, Sankagiri — 637301, Tamil Nadu
                </div>
              </div>
              <div>
          ...
          <div className="bg-white border border-gray-200 rounded-sm p-8 shadow-sm">
            {sent ? (
              <div className="flex flex-col items-center justify-center h-64 text-center">
                ...
                <button onClick={() => setSent(false)} className="mt-6 text-corp-red text-sm font-bold tracking-widest uppercase border-b border-corp-red pb-1">
                  Send Another
                </button>
              </div>
            ) : (
                ...
                {["name", "email"].map((field) => (
                  <div key={field}>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 border border-gray-300 rounded-sm focus:border-corp-blue focus:ring-1 focus:ring-corp-blue transition-all font-body bg-white"
                    />
                  </div>
                ))}
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 border border-gray-300 rounded-sm focus:border-corp-blue focus:ring-1 focus:ring-corp-blue transition-all resize-none font-body bg-white"
                  />
                </div>
                <button
                  type="submit"
                  disabled={isSubmitting}
                  className={`w-full py-4 font-bold text-sm tracking-widest uppercase transition-colors duration-200 rounded-sm shadow-md ${
                    isSubmitting ? "bg-gray-400 text-white cursor-wait" : "bg-corp-red hover:bg-corp-red-dark text-white"
                  }`}
                >
      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-10 relative z-10 bg-white/5 backdrop-blur-sm p-10 rounded-sm border border-white/10">
        ...
        <div className="prose prose-lg max-w-none text-gray-300 font-body leading-relaxed space-y-8">
          <p className="text-xl text-white font-medium">
            Raja Deepu Sooriya Private Limited was founded in 2025 upon a simple yet powerful premise:
            combining diverse expertise to create unified, high-performing business solutions.
          </p>
          <p>
            Rooted in Sankagiri, Tamil Nadu, our enterprise is the culmination of a deep-seated partnership
            between three driven founders. We recognized a growing gap in the market for reliable,
            transparent, and digitally-forward corporate services, specifically tailored to travel,
            tourism, and brand marketing.
          </p>
          <div className="p-8 bg-corp-blue border-l-4 border-corp-gold shadow-sm my-10">
            ...
            <p className="m-0 text-gray-300">
              Our mandate is to operate with uncompromising integrity. Whether we are designing international
              travel packages through MyTripRaja, or scaling local businesses through MarketerRaja, our
              commitment to corporate governance, financial transparency, and measurable results remains absolute.
            </p>
          </div>
          <p>
            Looking to the future, we are actively expanding our digital footprint and establishing new
            operational milestones. Our goal is not just to participate in the industries we operate within,
            but to redefine their standard of service.
          </p>
        </div>
      </div>
    </div>
...
function DirectorPage({ id }) {
  useEffect(() => { window.scrollTo(0, 0); }, []);
  const directorsData = {
    raja:    { fullName: "Raja",                role: "Director & Co-Founder", color: "bg-corp-blue",     bio: "As a founding pillar of the organization, Raja leads the corporate strategy and high-level stakeholder relationship management. With a visionary approach to business expansion, he ensures that the company's long-term objectives align with emerging market trends." },
    deepu:   { fullName: "Deepadharsan Rajavel", role: "Director & Co-Founder", color: "bg-corp-red",      bio: "Deepadharsan holds a Master of Commerce and brings deep expertise in corporate governance, financial reporting, and strict GST compliance to the board. With a strong professional interest in sustainable business development and green accounting practices, he ensures that Raja Deepu Sooriya Private Limited operates on a financially sound, transparent, and forward-looking foundation." },
    sooriya: { fullName: "Balasooriya",          role: "Director & Co-Founder", color: "bg-corp-blue-mid", bio: "Balasooriya is the technology and innovation champion of the enterprise. He oversees the digital architecture that powers our brands, ensuring that platforms like MyTripRaja and MarketerRaja are equipped with cutting-edge tools and seamless user experiences." },
  };
...
// ─── FOOTER ───────────────────────────────────────────────────────────────────
function Footer({ navigateTo }) {   // ✅ FIX 4: prop was missing in original call
  return (
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          <div className="lg:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <div className="text-corp-gold text-[10px] tracking-[0.2em] uppercase mt-0.5">Private Limited</div>
              </div>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed font-body max-w-xs mb-5">
              An enterprise built on integrity, innovation, and shared vision — proudly rooted in Tamil Nadu.
            </p>
            <div className="flex gap-4 mt-6">
              <a href="https://www.instagram.com/rajadeepusooriya" target="_blank" rel="noopener noreferrer"
                className="w-8 h-8 rounded-sm bg-white/10 hover:bg-corp-red flex items-center justify-center text-white transition-colors duration-200">
              ...
              <a href="https://www.linkedin.com/company/rajadeepusooriya" target="_blank" rel="noopener noreferrer"
                className="w-8 h-8 rounded-sm bg-white/10 hover:bg-corp-red flex items-center justify-center text-white transition-colors duration-200">
          ...
          <div>
            ...
            <div className="space-y-4">
              {[["CIN", "U79120TZ2025PTC034817"], ["GSTIN", "33AAOCR6737N1ZN"]].map(([k, v]) => (
                <div key={k}>
                  <div className="text-gray-400 text-[10px] font-bold tracking-widest uppercase">{k}</div>
                  <div className="text-gray-300 text-xs font-mono leading-relaxed mt-0.5">{v}</div>
                </div>
              ))}
            </div>
          </div>
          <div>
            ...
            <address className="text-gray-400 text-xs leading-relaxed not-italic font-body">
              17/1 DS Apartment,<br />Tiruchengode Road,<br />Sankagiri — 637301,<br />Tamil Nadu, India
            </address>
          </div>
        </div>
    ...
    <div className="font-body antialiased relative">
      ...
      {view === "home" && (
        <>
          ...
          <CoreValues />
          <Brands />
          {/* ✅ FIX 2: Testimonials now actually rendered */}
          <Testimonials />
          {/* ✅ FAQ PRESERVED: Keeping the FAQ section we added earlier */}
          <FAQ navigateTo={navigateTo} />
          {/* ✅ FIX 3: Blog rendered cleanly */}
          <Blog />
          <Contact />
        </>
      )}
